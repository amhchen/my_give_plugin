	...
	<form id="give-login-form" class="give-form" action="" method="post">
		<fieldset>
			...
			<div class="give-login-username give-login">
				<label for="give_user_login"><?php _e( 'Username or Email', 'give' ); ?></label>
				<input name="give_user_login" id="give_user_login" class="give-required give-input" type="text" title="<?php _e( 'Username or Email', 'give' ); ?>" />
			</div>
