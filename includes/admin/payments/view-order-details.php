...
function anon_or_not_head($payment_id) {
	echo "<th>Publish Donor Name?</th>";
}
add_action('give_donation_details_thead_after','anon_or_not_head');
...
function hide_from_user_head($payment_id) {
	echo "<th>Publish Message?</th>";
}
add_action('give_donation_details_thead_after','hide_from_user_head');
						...
						<div id="normal-sortables" class="meta-box-sortables ui-sortable">
							...
							<div id="give-donation-overview" class="postbox <?php echo $column_count; ?>">
								...
								<div class="inside">
									...
									<strong>Message: </strong><br><?php echo $payment_meta['message']; ?>
								</div>
								<!-- /.inside -->
