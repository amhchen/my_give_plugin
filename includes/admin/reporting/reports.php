...
function export_user_row() {
	?>
<tr><td class="row-title">
		<h3><span><?php _e( 'Export User Campaigns', 'give' ); ?></span></h3>
		...
		<form method="post" id="give_user_export">
			...
			<input type="submit" value="<?php _e( 'Export User Campaigns', 'give' ); ?>" class="button-secondary" />
		</form>
	</td></tr>
<?php
}
