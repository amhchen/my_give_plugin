...
function give_run_install() {
	...
	if (! get_post( give_get_option( 'edit_campaign_page') ) ) {
		$edit_page = wp_insert_post(
			array(
				'post_title'     => __( 'Campaign Details', 'give' ),
				'post_content'   => '[post_creator]',
				'post_status'    => 'publish',
				'post_author'    => 1,
				'post_type'      => 'page',
				'comment_status' => 'closed'
		...
		$options['edit_campaign_page'] = $edit_page;
	}

	if (! get_post( give_get_option( 'login_page') ) ) {
		$login_page = wp_insert_post(
			array(
				'post_title'     => __( 'Login', 'give' ),
				'post_content'   => '[give_login]',
				'post_status'    => 'publish',
				'post_author'    => 1,
				'post_type'      => 'page',
				'comment_status' => 'closed'
	...
	if (! get_post( give_get_option( 'register_page') ) ) {
		$register_page = wp_insert_post(
			array(
				'post_title'     => __( 'Get Involved', 'give' ),
				'post_content'   => '[give_register]',
				'post_status'    => 'publish',
				'post_author'    => 1,
				'post_type'      => 'page',
				'comment_status' => 'closed'
	...
	$attachment_id = media_handle_upload(GIVE_PLUGIN_URL . '/assets/images/placeholder.png', 0);
