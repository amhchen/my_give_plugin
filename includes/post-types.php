...
function give_setup_post_types() {
	...
	$give_forms_labels = apply_filters( 'give_forms_labels', array(
		'name'               => __( 'Causes %2$s', 'give' ),
		'singular_name'      => '%1$s',
		'add_new'            => __( 'Add %1$s', 'give' ),
		'add_new_item'       => __( 'Add New Cause %1$s', 'give' ),
		'edit_item'          => __( 'Edit Cause %1$s', 'give' ),
		...
		'parent_item_colon'  => '',
		'menu_name'          => apply_filters( 'give_menu_name', __( 'Causes', 'give' ) ),
		'name_admin_bar'     => apply_filters( 'give_name_admin_bar_name', __( 'Causes', 'give' ) )
	) );
...
function give_setup_taxonomies() {
	...
	if ( give_get_option( 'enable_categories' ) == 'on' ) {
		...
		wp_insert_term('active','give_forms_category');
		wp_insert_term('expired','give_forms_category');
		wp_insert_term('cause','give_forms_category');
	}
